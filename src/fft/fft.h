...
//   When utilizing credit LIBROW site http://www.librow.com/articles/article-10

//	 The FFT algorithm implemented is called Cooley-Tukey.
//	 The length of input data for the algorithm should be power of 2.
